...
veg.table(Y, cat, min.const = 0.3, method = "aho", cover.only = FALSE, row.order = NULL)
}

\arguments{

  \item{Y}{A site x species (\emph{n x p}) community matrix.}
  ...
  \item{row.order}{Customized row order with respect to original order in \code{Y}}
}
\details{
