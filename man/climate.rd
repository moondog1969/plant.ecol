...
\format{
  ...
  \describe{
    \item{\code{Aberdeen.WA.USA}}{Weather station HOQUIAM BOWERMAN AP is at about 46.971\eqn{^\circ}N 123.94\eqn{^\circ}W. Elevation about 4.3m above sea level. Temp data from 1954-2024, precip from 1953-2024. (Updated 1/16/22025)}
...
Temp data from 1961-1990, Precip data from 1886-1989.  Data derived from NCDC TD 9641 Clim 81.}
    ...
    \item{\code{Corvallis.OR.USA}}{Weather station CORVALLIS STATE UNIV, BENTON COUNTY is at about 44.63\eqn{^\circ}N 123.20\eqn{^\circ}W. Elevation about 68m above sea level. Temp data from 1893-2024, Precip from 1894-2024.
(Updated 1/16/2025)}
...
Temp data 1931-1990, Precip from 1890-1985 derived from GHCN 1.
    ...
    \item{\code{Pocatello.ID.USA}}{Weather station POCATELLO MUNICIPAL, POWER COUNTY is at about 42.91\eqn{^\circ}N 112.60\eqn{^\circ}W. Elevation 1357m above sea level.  Temp data from 1939-2024. Precip data from 1939-2024. (Updated 1/16/2025)}
...
Temp and Precip data from 1961-1990. Summaries from GHCN 1. }
    \item{\code{San.Francisco.CA.USA}}{Weather station SAN FRANCISCO DOWNTOWN is at about 37.79\eqn{^\circ}N 122.40\eqn{^\circ}W. Elevation about 16m above sea level. Temp data from 1874-2024, Preip from 1849-2024.}
